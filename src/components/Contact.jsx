        ...
        >
          ...
          <label className="flex flex-col">
            ...
            <div className={`border-2 border-dashed rounded-lg p-4 ${
              ...
              >
                <div className="bg-[#915eff]/20 hover:bg-[#915eff]/30 transition-all duration-300 rounded-lg p-6 w-full text-center">
                  {resumeFile ? (
                    <div className="flex flex-col items-center">
                      ...
                      <span className="text-white-100 font-medium">{resumeFile.name}</span>
                      <span className="text-gray-400 text-sm mt-1">Click to change file</span>
                    </div>
                  ) : (
                    <div className="flex flex-col items-center">
                      <div className="upload-animation mb-3">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-[#915eff] animate-pulse" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                        </svg>
                      </div>
                      <span className="text-white-100 font-medium text-lg">Drop your resume here</span>
                      <span className="text-gray-400 text-sm mt-1">or click to browse (PDF only)</span>
                    </div>
                  )}
                </div>
              </label>
